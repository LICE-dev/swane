...
:class:`~swane.nipype_pipeline.interfaces.ram_estimators.RecoBundlesRamEstimator`
...
from swane.nipype_pipeline.interfaces.dipy.DipyAtlasSLR import ATLAS_SUBDIR, ATLAS_NAME
...
def recognize_chunk(
    ...
    *,
    ...
    :class:`~swane.nipype_pipeline.interfaces.dipy.DipyBundleRecovery.DipyBundleRecovery`'s
...
class DipyRecoBundlesRecognize(BaseInterface):
    ...
    :class:`~swane.nipype_pipeline.interfaces.dipy.DipyBundlesToRef.DipyBundlesToRef`'s job.
