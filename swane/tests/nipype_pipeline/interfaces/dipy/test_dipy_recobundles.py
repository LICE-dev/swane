...
* :class:`~swane.nipype_pipeline.interfaces.dipy.DipyRecoBundles.DipyRecoBundlesBuild`
...
* :class:`~swane.nipype_pipeline.interfaces.dipy.DipyBundleUnion.DipyBundleUnion`
  concatenates N per-chunk recognitions back into one bundle;
* :class:`~swane.nipype_pipeline.interfaces.dipy.DipyBundlesToRef.DipyBundlesToRef`
...
class TestThreadPinning:
    def test_omp_pinned_during_recognition(
        ...
        import swane.nipype_pipeline.interfaces.dipy.DipyRecoBundles as mod
