"""Unit tests for
:class:`swane.nipype_pipeline.interfaces.dipy.DipyAtlasSLR.DipyAtlasSLR`.
...
from swane.nipype_pipeline.interfaces.dipy.DipyAtlasSLR import (
    DipyAtlasSLR,
...
class TestSlrOutputs:
    ...
    def test_no_fetch_when_atlas_present(
        ...
        import swane.nipype_pipeline.interfaces.dipy.DipyAtlasSLR as mod
