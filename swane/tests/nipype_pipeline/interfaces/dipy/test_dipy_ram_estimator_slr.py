"""Tests for
:class:`swane.nipype_pipeline.interfaces.ram_estimators.DipySlrRamEstimator`.
...
from swane.nipype_pipeline.interfaces.ram_estimators import DipySlrRamEstimator
