...
:class:`swane.nipype_pipeline.interfaces.ram_estimators.DipyMotionRamEstimator`.
...
from swane.nipype_pipeline.interfaces.ram_estimators import DipyMotionRamEstimator
...
class TestTunedEquivalence:
    ...
    def test_bottom_rung_output_is_bit_for_bit_identical(self, tmp_path):
        from swane.tests.nipype_pipeline.interfaces.dipy.test_dipy_motion import (
            ORACLE_ROOT,
            _make_synthetic_dwi,
        )
