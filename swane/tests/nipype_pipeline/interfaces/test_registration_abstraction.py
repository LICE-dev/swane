"""Tests for the backend-aware registration abstraction in ``interfaces/utils.py``.
...
class TestGetRegistrationNode:
    def _call(self, engine, make_nifti, **kwargs):
        ...
        from swane.nipype_pipeline.interfaces.utils import get_registration_node
...
class TestResolveRegistrationEngine:
    def test_default_is_ants(self, global_config):
        ...
        from swane.nipype_pipeline.interfaces.utils import resolve_registration_engine
...
class TestApplyRegistrationNode:
    ...
    def test_fsl_apply_unchanged(self, make_nifti):
        from swane.nipype_pipeline.interfaces.utils import apply_registration_node
