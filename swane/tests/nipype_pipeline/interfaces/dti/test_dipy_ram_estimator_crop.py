"""Tests for
:class:`swane.nipype_pipeline.interfaces.ram_estimators.DipyCropRamEstimator`.
...
from swane.nipype_pipeline.interfaces.ram_estimators import DipyCropRamEstimator
