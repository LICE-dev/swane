"""Unit tests for
:class:`swane.nipype_pipeline.interfaces.dti.AffineToRAS.AffineToRAS`.
...
because :class:`~swane.nipype_pipeline.interfaces.dipy.DipyTracking.DipyTracking` feeds it
