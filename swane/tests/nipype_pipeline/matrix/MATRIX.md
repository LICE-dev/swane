...
| scenario | settings | nodes/edges | commands | GPU |
|----------|----------|-------------|----------|-----|
| [new_eddy_cpu](snapshots/dti_preproc/new_eddy_cpu.txt) | cuda=false; deskull_engine=ANTSPYNET; max_cpu=4; old_eddy_correct=false; synth_morph=False; tractography=false | 12 / 21 | `convert_xfm`, `dcm2niix`, `dtifit`, `eddy_openmp`, `flirt` | `use_cuda=False` |
...
| [test_run](snapshots/fmri_preproc/test_run.txt) | TR=2.0; del_end_vols=0; del_start_vols=0; hpcutoff=30; n_vols=100; slice_timing=UP; test_run=True | 27 / 41 | `dcm2niix`, `flirt`, `mcflirt`, `niimath`, `slicetimer`, `susan` | — |
| [trim_start_end_vols](snapshots/fmri_preproc/trim_start_end_vols.txt) | TR=3.0; del_end_vols=3; del_start_vols=5; hpcutoff=50; n_vols=120; slice_timing=UP | 27 / 41 | `dcm2niix`, `flirt`, `mcflirt`, `niimath`, `slicetimer`, `susan` | — |
...
| scenario | settings | nodes/edges | commands | GPU |
|----------|----------|-------------|----------|-----|
| [autorecon_pial](snapshots/freesurfer/autorecon_pial.txt) | hippo_amyg_labels=False; limit_synth_cores=false; max_cpu=4; step=AUTORECON_PIAL; synth_reconall=false; synthseg_fast=False | 11 / 16 | `mri_vol2vol`, `niimath`, `recon-all` | — |
...
| [reconall](snapshots/freesurfer/reconall.txt) | hippo_amyg_labels=False; limit_synth_cores=false; max_cpu=4; step=RECONALL; synth_reconall=false; synthseg_fast=False | 12 / 18 | `mri_vol2vol`, `niimath`, `recon-all` | — |
| [reconall_hippo](snapshots/freesurfer/reconall_hippo.txt) | hippo_amyg_labels=True; limit_synth_cores=false; max_cpu=4; step=RECONALL; synth_reconall=false; synthseg_fast=False | 15 / 25 | `mri_vol2vol`, `niimath`, `recon-all`, `segmentHA_T1.sh` | — |
| [reconall_synth_tools](snapshots/freesurfer/reconall_synth_tools.txt) | hippo_amyg_labels=False; limit_synth_cores=false; max_cpu=4; step=RECONALL; synth_reconall=true; synthseg_fast=False | 12 / 18 | `mri_vol2vol`, `niimath`, `recon-all` | — |
| [reconall_test_run](snapshots/freesurfer/reconall_test_run.txt) | max_cpu=4; step=RECONALL; test_run=True | 12 / 18 | `mri_vol2vol`, `niimath`, `recon-all` | — |
| [synthseg](snapshots/freesurfer/synthseg.txt) | hippo_amyg_labels=False; limit_synth_cores=false; max_cpu=4; step=SYNTHSEG; synth_reconall=false; synthseg_fast=False | 8 / 11 | `mri_synthseg`, `mri_vol2vol`, `niimath` | — |
| [synthseg_fast](snapshots/freesurfer/synthseg_fast.txt) | hippo_amyg_labels=False; limit_synth_cores=false; max_cpu=4; step=SYNTHSEG; synth_reconall=false; synthseg_fast=True | 8 / 11 | `mri_synthseg`, `mri_vol2vol`, `niimath` | — |
| [synthseg_limit_cores](snapshots/freesurfer/synthseg_limit_cores.txt) | hippo_amyg_labels=False; limit_synth_cores=true; max_cpu=4; step=SYNTHSEG; synth_reconall=false; synthseg_fast=False | 8 / 11 | `mri_synthseg`, `mri_vol2vol`, `niimath` | — |
| [synthseg_test_run](snapshots/freesurfer/synthseg_test_run.txt) | max_cpu=4; step=SYNTHSEG; test_run=True | 8 / 11 | `mri_synthseg`, `mri_vol2vol`, `niimath` | — |
...
| [pet_reconall_ai](snapshots/func_map/pet_reconall_ai.txt) | ai=true; config=PET; cost_func=MUTUAL_INFORMATION; freesurfer_step=RECONALL | 21 / 43 | `applywarp`, `dcm2niix`, `flirt`, `mri_vol2surf`, `niimath` | — |
| [reconall_ai](snapshots/func_map/reconall_ai.txt) | ai=true; config=ASL; cost_func=NORMALIZED_MUTUAL_INFORMATION; freesurfer_step=RECONALL | 21 / 43 | `applywarp`, `dcm2niix`, `flirt`, `mri_vol2surf`, `niimath` | — |
| [reconall_no_ai](snapshots/func_map/reconall_no_ai.txt) | ai=false; config=ASL; cost_func=NORMALIZED_MUTUAL_INFORMATION; freesurfer_step=RECONALL | 13 / 26 | `dcm2niix`, `flirt`, `mri_vol2surf`, `niimath` | — |
...
| [single_series_synth_backend](snapshots/venous_mr/single_series_synth_backend.txt) | deskull_engine=SYNTHSTRIP; limit_synth_cores=false; max_cpu=4; synth_morph=true; two_series=False; vein_detection_mode=SD | 12 / 14 | `dcm2niix`, `mri_synthmorph`, `mri_synthstrip`, `niimath` | — |
| [single_series_synth_backend_limit_cores](snapshots/venous_mr/single_series_synth_backend_limit_cores.txt) | deskull_engine=SYNTHSTRIP; limit_synth_cores=true; max_cpu=4; synth_morph=true; two_series=False; vein_detection_mode=SD | 12 / 14 | `dcm2niix`, `mri_synthmorph`, `mri_synthstrip`, `niimath` | — |
