...
GLOBAL_PREFERENCES[category]["limit_cores"] = PreferenceEntry(
    ...
    tooltip="Caps SynthStrip, SynthMorph and SynthSeg CPU usage instead of "
    "following the general multi-core policy set above",
    default=False,
    pref_requirement={GlobalPrefCategoryList.PERFORMANCE: [("max_subj_cpu", 2)]},
    pref_requirement_fail_tooltip="Requires more than 1 CPU core allocated per subject",
)
