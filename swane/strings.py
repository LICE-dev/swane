...
mainwindow_new_pt_created = "New patient created: "
...
pttab_generate_scene_button = "Create/Update Slicer scene " + INFOCHAR
pttab_generate_scene_button_tooltip = "In case of a new analysis remember to update the Slicer scene"
pttab_generate_scene_button_disabled_tooltip = "Slicer not detected"
pttab_load_scene_button = "Visualize scene into Slicer"
pttab_load_scene_button_tooltip = "Create a Slicer scene first"
pttab_open_results_directory = "Open results folder"
...
pttab_wf_error_oom = "Process killed (possible Out of Memory). Try to reduce CPU core limit in performance preferences"
pttab_wf_error_terminated = "Process terminated. This can occur if user manually terminates a running process."
pttab_tabtooltip_exec_disabled_series = "A 3D T1w series is required to enable workflow execution"
pttab_tabtooltip_exec_disabled_dependency = "Mandatory dependencies are required to enable workflow execution"
pttab_tabtooltip_result_disabled = "Complete a workflow first"
