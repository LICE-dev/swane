...
pttab_wf_error_oom = "Process killed (possibile Out of Memory). Try to reduce CPU core limit in performance preferences"
...
node_names["Eddy"] = "eddy current correction"
