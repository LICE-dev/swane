...
<p align="center">
  <a href="#">
    <img alt="SWANe" title="SWANe" src="swane/resources/icons/swane.png">
  </a>
</p>
...
* Added a `filelock` version constraint to avoid a multiprocessing issue with Nipype 1.10.0.

#### Changed

* Minor layout improvements in `ToolReferenceWindow`.
